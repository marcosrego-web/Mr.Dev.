...
$doc->addScript(JURI::base().'modules/mod_yngdev/assets/js/utils_v090.js');
$doc->addScript(JURI::base().'modules/mod_yngdev/assets/js/main_v090.js');

$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/assets/css/utils_v090.css');
$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/assets/css/main_v090.css');
...
if(!$params['appearance']->theme || $params['appearance']->theme != 'Custom') {
	...
	if($theme != 'None') {
		...
		$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/themes/'.$theme.'/'.$theme.'_v090.css');
