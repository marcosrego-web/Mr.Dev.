...
$doc->addScript(JURI::base().'modules/mod_yngdev/assets/js/utils.js', array('version'=>'0.9.30'));


$doc->addScript(JURI::base().'modules/mod_yngdev/assets/js/module.js', array('version'=>'0.9.30'));


$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/assets/css/utils.css', array('version'=>'0.9.30'));


$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/assets/css/module.css', array('version'=>'0.9.30'));
...
if(!$params['appearance']->theme || $params['appearance']->theme != 'Custom') {
	...
	if($theme != 'None') {
		...
		$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/themes/'.$theme.'/'.$theme.'.css', array('version'=>'0.9.30'));
	...
	$doc->addStyleSheet(JURI::base(true).'/templates/mrdev/'.$theme.'/'.$theme.'.css', array('version'=>'0.9.30'));
