...
$doc->addScript(JURI::base().'modules/mod_yngdev/assets/js/yngdev_v071.js');
$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/assets/css/yngdev_v071.css');
...
if(!$params['appearance']->theme || $params['appearance']->theme != 'Custom') {
	...
	if($theme != 'None') {
		...
		$doc->addStyleSheet(JURI::base().'modules/mod_yngdev/themes/'.$theme.'/'.$theme.'_v071.css');
	} else {
		$layout = 'none';
		$layoutoptions = array();
	}
