		...
		<?php
						...
						<label  for="<?php echo $this->get_field_id( 'orderby' ); ?>"><?php _e( 'Sort by:' ); ?></label><br>
								<select  class="widefat" id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>">
									<?php
										$options = array( 'Parent','Title','Creation','Article count','Slug');
						...
						Theme:<br>
								...
								if($theme == "" || $theme == null) {
									...
									if($theme == "default") {
										...
										include trailingslashit( get_template_directory( __DIR__ )).'mrdev/themes/'.$theme.'/index.php';
									}
								}
								?>
								</div>
						...
						<p>
									...
									<label ><input type="checkbox" class="mrwid-checkbox" name="<?php echo esc_attr( $this->get_field_name( 'pagetoggles' ) ); ?>[]" value="pageselect" <?php if( is_array( $pagetoggles ) && in_array( 'pageselect', $pagetoggles ) || !is_array( $pagetoggles ) || is_array( $pagetoggles ) && !in_array( 'pageselect', $pagetoggles ) && !in_array( 'arrows', $pagetoggles ) && !in_array( 'radio', $pagetoggles ) && !in_array( 'below', $pagetoggles) && !in_array( 'scroll', $pagetoggles) ) { echo 'checked="checked"'; } ?> /> <?php _e( 'Select' ); ?></label><br>
									<label ><input type="checkbox" class="mrwid-checkbox" name="<?php echo esc_attr( $this->get_field_name( 'pagetoggles' ) ); ?>[]" value="arrows" <?php checked( ( is_array($pagetoggles) AND in_array( "arrows", $pagetoggles ) ) ? "arrows" : '', "arrows" ); ?> /> <?php _e( 'Arrows' ); ?></label><br>
						...
						<?php if($catlink !=null && $catlink != "No bottom link") { ?>
